                        ...
                        <div class="white-box">
                                ...
                                <div class="">
                                    <div class="right-page-header">
                                        ...
                                        <h3>Edit Advertisement </h3> </div>
                                    <div class="clearfix"></div>
                                    <div class="scrollable">
									
                                       <form class="form-horizontal form-material" action="<?php echo base_url();?>advertisement/edit/<?php echo $data[0]->id;?>" method="post" name="advertisement" enctype="multipart/form-data">
                                                                      
                                                                            <div class="form-group">
                                                                                <div class="col-md-12 m-b-20">
                                                                                    <input type="text" name="name" class="form-control" placeholder="Advertisement name" value="<?php echo $data[0]->name;?>"><?php echo form_error('name');?> </div>
                                                                               
                                                                                <div class="col-md-12 m-b-20">
                                                                                    <input type="text" name="start_date" class="form-control mydatepicker1"  placeholder="mm/dd/yyyy" value="<?php echo date('m-d-Y',strtotime($data[0]->start_date));?>"><?php echo form_error('start_date');?> </div>
																				 <div class="col-md-12 m-b-20">
                                                                                    <input type="text" name="end_date" class="form-control mydatepicker2"  placeholder="mm/dd/yyyy"" placeholder="" value="<?php echo date('m-d-Y',strtotime($data[0]->end_date));?>"><?php echo form_error('end_date');?> </div>
