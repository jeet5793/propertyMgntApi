                        ...
                        <div class="white-box">
                                ...
                                <div class="">
                                    ...
                                    <div class="scrollable">
                                       ...
                                       <form class="form-horizontal form-material" action="<?php echo base_url();?>blog/edit/<?php echo $data[0]->id;?>" method="post" name="blog" enctype="multipart/form-data">
                                                                      
                                                                            <div class="form-group">
                                                                                <div class="col-md-12 m-b-20">
                                                                                    <input type="text" name="name" class="form-control" placeholder="Blog name" value="<?php echo $data[0]->name;?>"><?php echo form_error('name');?> </div>
