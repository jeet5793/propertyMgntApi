            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                   <?php /*<li class="user-pro">
					...
					<li><a href="<?php echo base_url();?>agent_review" class="waves-effect"><i class="mdi mdi-home fa-fw"></i> <span class="hide-menu">Agent Review</span></a></li>
					...
					<li><a href="<?php echo base_url();?>contactinfo" class="waves-effect"><i class="mdi mdi-settings fa-fw"></i> <span class="hide-menu">Contact Information </span></a></li>
