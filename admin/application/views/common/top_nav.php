 <!-- Topbar header - style you can find in pages.scss -->
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <?php /*<ul class="nav navbar-top-links navbar-left">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"><?php /*<img src="<?php echo base_url();?>assets/plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle">*/?><i class="fa fa-user"></i> <b class="hidden-xs"><?php echo $this->session->userdata('username');?></b><span class="caret"></span> </a>
                        <ul class="dropdown-menu dropdown-user animated flipInY">
                           <?php /* <li>
                                <div class="dw-user-box">
                                    <div class="u-img"><i class="fa fa-user"></i><img src="<?php echo base_url();?>assets/plugins/images/users/varun.jpg" alt="user" /></div>
                                    <div class="u-text">
                                        <h4><?php echo $this->session->userdata('username');?></h4>
                                        <?php /*<p class="text-muted"><?php echo $this->session->userdata('email');?></p><a href="<?php echo base_url();?>profile" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
                                </div>
                            </li>*/?>
                            <li role="separator" class="divider"></li>
                            <li><a href="<?php echo base_url();?>profile"><i class="ti-user"></i> My Profile</a></li>
                            <li><a href="<?php echo base_url();?>dashboard"><i class="ti-wallet"></i> Dashboard</a></li>
                            <?php /*<li><a href="#"><i class="ti-email"></i> Inbox</a></li>*/?>
                            <li role="separator" class="divider"></li>
                            <li><a href="<?php echo base_url();?>settings"><i class="ti-settings"></i>Setting</a></li>
                            <li role="separator" class="divider"></li>
