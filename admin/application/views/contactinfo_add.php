                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                                ...
                                <div class="">
									...
									<?php echo form_open(base_url().'contactinfo/add', 'class="form-horizontal form-material" id="planform" name="contactinfo" ');?>
                                     
                                        <div class="form-group">
										<div class="col-md-12 m-b-20">
											<textarea name = "address" class="form-control" placeholder="Please enter address"></textarea>
											</div>
                                            <div class="col-md-12 m-b-20">
											<?php 
												$data = array(
											...
											<div class="col-md-12 m-b-20" id="email">
                                                <?php 
													$data = array(
