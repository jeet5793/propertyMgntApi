                        ...
                        <div class="white-box">
                                ...
                                <div class="">
                                    ...
                                    <?php //print_r($data);
										...
										$plan_id[$data[0]['plan_id']] = $data[0]['plan'];
										$status = $data[0]['status'];
										$id = $data[0]['id'];
										$limit_upto= $data[0]['limit_upto'];
									...
									<?php echo form_open(base_url().'featuremapper/edit/'.$id, 'class="form-horizontal form-material" id="planform" name="featuremapper" ');?>
                                        ...
                                        <div class="form-group">
											...
											$js = array(
												...
												echo form_dropdown('user_type', $typeArr,$user_type, $js);
											...
											$js = array(
												...
												echo form_dropdown('plan',$plan_id,'', $js);
											...
											foreach($feature as $featureval)
											{
												...
												echo form_dropdown('feature', $featureArr,$feature_id, ['class' => 'form-control','onChange' => 'getFeatureunit();','id'=>'feature']);
												 echo "<small>".form_error('feature')."</small>";
											?>
												
											</div>
											<?php //if($limit_upto!=''){?>
											<div class="col-md-12 m-b-20" id="limitupto">
                                                <?php 
													$data = array(
															'type'  => 'text',
															'name'  => 'limitupto',
										...
										<?php //if($confirmation!=null){?>
										 <div class="col-md-12 m-b-20" id="feature_unit">
                                                    <input type="radio" name="feature_unit" class=""  value="Yes" <?php echo set_radio('confirm', 'Yes',(($confirmation=='Yes')?True:False))?>>Yes
													<input type="radio" name="feature_unit" class="" value="No" <?php echo set_radio('confirm', 'No',(($confirmation=='No')?True:False))?>>No </div>
										<?php //}?>		
                                              <div class="col-md-12 m-b-20">
