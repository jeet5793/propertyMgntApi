                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr class="advance-table-row active">
                                                        ...
                                                        <td style="width: 60px;"><img src="<?php if($datas->profile_photo!=''){echo base_url();?>assets/uploads/<?php echo $datas->profile_photo;}else{ echo base_url();?>assets/img_not_available.png";<?php }?> class="img-circle" width="40" heigh="40" alt="" /></td>
