                                ...
                                <div class="overlay-box">
                                    <div class="user-content">
                                         <?php foreach($data as $owner_data){
											 if($owner_data->profile_photo!=''){
												$img =  "../".$owner_data->profile_photo;
											 }else
												$img = "assets/plugins/images/no-img.jpg";
                                    ?>
                                        <a href="javascript:void(0)"><img src="<?php echo $img;?>" class="thumb-lg img-circle" alt="img"></a>
