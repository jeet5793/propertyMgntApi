                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                                ...
                                <div class="">
									...
									<?php echo form_open(base_url().'plan/add', 'class="form-horizontal form-material" id="planform" name="plan" ');?>
                                        ...
                                        <div class="form-group">
											...
											$options = array(
												...
												;
												echo form_dropdown('plan', $options,'', ['class' => 'form-control']);
											...
											foreach($planusers as $plan)
											{
												...
												echo form_dropdown('user_type',$planarr, '', ['class' => 'form-control']);
