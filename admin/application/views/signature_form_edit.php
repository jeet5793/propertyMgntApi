                        ...
                        <div class="white-box">
                            ...
                            <?php //print_r($data);
								 ...
								 $id = $data[0]['id'];
								  ...
								  $header_content = $data[0]['header_content'];
								  $footer_content = $data[0]['footer_content'];
								  $watermark_image = $data[0]['watermark_image'];
							...
							?>
                                <div class="row">
                                    ...
                                    <div class="scrollable">
                                      ...
                                      <?php echo form_open(base_url().'agreementform/edit/'.$id, 'class="form-horizontal form-material" id="planform" name="plan" enctype="multipart/form-data"');?>
                                        ...
                                        <div class="card-block">
                                          <div class="add-name">
											...
											<div class="col-md-12 m-b-20">
											 ...
											 <input type="hidden" name="header_image_old" value="<?php echo $header_image;?>">
											  <div class="col-md-12 m-b-20">
													<img src="<?php echo base_url().$header_image;?>" width="100">
                                              </div>
											 <div class="col-md-12 m-b-20">
                                                <?php 
													$data = array(
											  ...
											  <input type="hidden" name="wm_image_old" value="<?php echo $watermark_image;?>">
											  <div class="col-md-12 m-b-20">
													<img src="<?php echo base_url().$watermark_image;?>" width="100">
                                              </div>
											 <div class="col-md-12 m-b-20">
                                                <?php 
													$data = array(
